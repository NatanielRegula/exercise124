...
function observeFirstSection(target) {
    ...
    const intersectionObserverObserver = new IntersectionObserver((events)=>{
        ...
        deactivateSnapping();
        if (!latestEvent.isIntersecting && !scrolledInFromTop) activateSnapping();
    }, intersectionObserverOptions);
    intersectionObserverObserver.observe(target);
    return intersectionObserverObserver;
}
function observeLastSection(target) {
    const intersectionObserverOptions = {
        threshold: 0.8
    };
    let firstEvent = true;
...
function disposeSnapper() {
    for (const intersectionObserverObserver of intersectionObservers)intersectionObserverObserver.disconnect();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@fontsource-variable/inter":"cnBFU"}],"gkKU3":[function(require,module,exports) {
...
},{}],"cnBFU":[function() {},{}]},["kZatx","4j3ZX"], "4j3ZX", "parcelRequirefdd2")
